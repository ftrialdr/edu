  ...
  <!-- ======= Breadcrumbs ======= -->
    ...
    <section id="course-details" class="course-details">
      <div class="container" data-aos="fade-up">
        <?php 
          $pid=intval($_GET['idm']);
          $sql = "SELECT * from courses where id_materi=:idm";
          $query = $dbh->prepare($sql);
          $query -> (':idm', $idm, PDO::PARAM_STR);
          $query->execute();
          ...
          <div class="row">
            <div class="col-lg-8">
              ...
              <p><?php echo htmlentities($result->nama_file);?></p>
            </div>
            <div class="col-lg-4">

              <div class="course-info d-flex justify-content-between align-items-center">
                <h5>Materi : <?php echo htmlentities($result->id_materi);?></h5>
              </div>

              <div class="course-info d-flex justify-content-between align-items-center">
                <h5>Jurusan : <?php echo htmlentities($result->jurusan);?></h5>
              </div>

              <div class="course-info d-flex justify-content-between align-items-center">
                <h5>Kelas : <?php echo htmlentities($result->kelas);?></h5>
              </div>
